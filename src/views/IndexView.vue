    ...
    <div>
        ...
        <section class="wellcome_area clearfix" id="home">
                ...
                <div class="row h-100 align-items-center">
                    <div class="col-12 col-md">
                        <div class="wellcome-heading">
                            <h2>Sponsor Token</h2>
                            <h3>ST</h3>
                            <p>发布专属于你的区块链加密卡牌，获取意想不到的高额收益！</p>
                        </div>
                        <div class="get-start-area">
                            <div class="submit">Get Started</div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="welcome-thumb wow fadeInDown" data-wow-delay="0.5s">
                <img src="/static/assets/img/bg-img/welcome-img-token.png" class="" alt="">
            </div>
        </section>
        <!-- ***** Wellcome Area End ***** -->
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="special_description_img">
                                <img src="/static/assets/img/bg-img/special.png" alt="">
                            </div>
                        </div>
        ...
        <div class="video-section">
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <!-- Video Area Start -->
                        <div class="video-area" style="background-image: url(/static/assets/img/bg-img/video.jpg);">
                    ...
                    <div class="col-12">
                        ...
                        <div class="app_screenshots_slides owl-carousel">
                            <div class="single-shot">
                                <img src="/static/assets/img/scr-img/app-1.jpg" alt="">
                            </div>
                            <div class="single-shot">
                                <img src="/static/assets/img/scr-img/app-2.jpg" alt="">
                            </div>
                            <div class="single-shot">
                                <img src="/static/assets/img/scr-img/app-3.jpg" alt="">
                            </div>
                            <div class="single-shot">
                                <img src="/static/assets/img/scr-img/app-4.jpg" alt="">
                            </div>
                            <div class="single-shot">
                                <img src="/static/assets/img/scr-img/app-5.jpg" alt="">
                            </div>
                            <div class="single-shot">
                                <img src="/static/assets/img/scr-img/app-3.jpg" alt="">
                            </div>
                    ...
                    <div class="col-12 col-md-6 col-lg-5">
                        <div class="slider slider-nav">
                            <div class="client-thumbnail">
                                <img src="/static/assets/img/bg-img/client-3.jpg" alt="">
                            </div>
                            <div class="client-thumbnail">
                                <img src="/static/assets/img/bg-img/client-2.jpg" alt="">
                            </div>
                            <div class="client-thumbnail">
                                <img src="/static/assets/img/bg-img/client-1.jpg" alt="">
                            </div>
                            <div class="client-thumbnail">
                                <img src="/static/assets/img/bg-img/client-2.jpg" alt="">
                            </div>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-12 col-md-6 col-lg-3">
                        <div class="single-team-member">
                            <div class="member-image">
                                <img src="/static/assets/img/team-img/team-1.jpg" alt="">
                    ...
                    <div class="col-12 col-md-6 col-lg-3">
                        <div class="single-team-member">
                            <div class="member-image">
                                <img src="/static/assets/img/team-img/team-2.jpg" alt="">
                                <div class="team-hover-effects">
                                    <div class="team-social-icon">
                                        <a href="#">
                                            <i class="fa fa-facebook" aria-hidden="true"></i>
                    ...
                    <div class="col-12 col-md-6 col-lg-3">
                        <div class="single-team-member">
                            <div class="member-image">
                                <img src="/static/assets/img/team-img/team-3.jpg" alt="">
                                <div class="team-hover-effects">
                                    <div class="team-social-icon">
                                        <a href="#">
                                            <i class="fa fa-facebook" aria-hidden="true"></i>
                    ...
                    <div class="col-12 col-md-6 col-lg-3">
                        <div class="single-team-member">
                            <div class="member-image">
                                <img src="/static/assets/img/team-img/team-4.jpg" alt="">
                                <div class="team-hover-effects">
                                    <div class="team-social-icon">
                                        <a href="#">
                                            <i class="fa fa-facebook" aria-hidden="true"></i>
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="address-text">
                            <p>
                                <span>Address:</span> 40 Baria Sreet 133/2 NewYork City, US</p>
                        </div>
                        <div class="phone-text">
                            <p>
                                <span>Phone:</span> +11-225-888-888-66</p>
                        </div>
                        <div class="email-text">
                            <p>
                                <span>Email:</span> info.deercreative@gmail.com</p>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <!-- Form Start-->
